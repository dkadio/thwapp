...
public class DetailActivity extends Activity {
	...
	private void getintentContent() {
		equipments = (ArrayList<Equipment>) getIntent().getExtras().getSerializable(DetailListActivity.KEY_EQUIP_COLLECTION);
		Log.d(MYTAG, "Array erhalten: " + equipments.toString() );
		selectedItem = getIntent().getExtras().getInt(DetailListActivity.KEY_SELECTED_EQUIP);
